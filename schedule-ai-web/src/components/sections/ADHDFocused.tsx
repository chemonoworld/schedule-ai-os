  ...
  return (
    <section className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="orb-dark w-[400px] h-[400px] -bottom-40 -left-40" />
      </div>
...
function ShieldIcon() {
  return (
    <svg className="w-7 h-7 text-white dark:text-zinc-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
